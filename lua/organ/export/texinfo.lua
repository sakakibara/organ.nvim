-- GNU Texinfo (.texi) exporter for org buffers.
--
-- Pipeline: optional #+SETUPFILE / #+INCLUDE expansion -> optional
-- native-citation preprocess -> from_org (org -> AST) -> to_texinfo (AST ->
-- Texinfo document) -> optional citation finalize.
...
function M.export(src, opts)
  ...
  local ast = require("organ.export.prepare").ast(lines, opts, "texinfo")
