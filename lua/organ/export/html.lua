...
-- native-citation preprocess -> from_org (org -> AST) -> to_html (AST ->
-- HTML5 document) -> optional citation finalize.
...
function M.export(src, opts)
  ...
  local ast = require("organ.export.prepare").ast(lines, opts, "html")
  local result = require("organ.ast.to_html").render(ast, opts)
