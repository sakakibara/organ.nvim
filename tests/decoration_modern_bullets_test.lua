...
-- per-row bullet map via the tree-sitter headline walk + line scan
-- over the visible range, and that on_line emits the right conceal
-- extmarks for each row (heading bullets, list markers, checkboxes).
