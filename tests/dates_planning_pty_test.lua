...
check("calendar glyph renders on the SCHEDULED line", kv.cal_at ~= nil and kv.cal_at ~= "nil",
  "line: " .. tostring(kv.line))
check("the < > brackets are concealed on the planning line",
  kv.line and kv.line:find("<") == nil and kv.line:find(">") == nil, "line: " .. tostring(kv.line))
